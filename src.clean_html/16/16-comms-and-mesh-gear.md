...
**Mission Recorder:** This device records all mission data: lifelogs, XP, sensor feeds, etc. Common practice is to link this to a radio booster near the gate, so that it remotely archives the data and is easily retrieved by search-and-rescue teams if something goes wrong.
