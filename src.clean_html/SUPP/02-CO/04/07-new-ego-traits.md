...
| [Async Familiarity](#async-familiarity)       |    1    | After 1 hour of observation, use Kinesics to identify an async.                                                 |
| [Brain Worm](#brain-worm)                     |    2    | Target is only aware of sleight if you roll superior failure.                                                   |            Asyncs |
| [Controlled Infection](#controlled-infection) |    1    | Use Moxie to choose specific influence effect.                                                                  |            Asyncs |
| [Danger Instinct](#danger-instinct)           |    1    | +2 Initiative. WIL Check to control action if surprised.                                                        |           Uplifts |
| [Data Control](#data-control)                 |  1/2/3  | −10 modifier per level to Research/Rep Tests to track and find info on you online.                              |
| [Digital Ghost](#digital-ghost)               |    1    | Use Insight to automatically negate attempt to zero in on you.                                                  |
| [Drone Whisperer](#drone-whisperer)           |    1    | Once per session, use Flex on test made by autonomous drone following your orders.                              |
| [Dual Strains](#dual-strains)                 |    1    | 2 infections, use trait/sleights/influence from only one at a time, switch when Infection Test fails.           |            Asyncs |
| [Edge Runner](#edge-runner)                   |    2    | Ignore −10 modifier from systems on active alert.                                                               |
| [Ego Plasticity](#ego-plasticity)             |   1/4   | Ignore psychosurgery SV (for one procedure/all), except treat crit fails as normal fails.                       |
| [Exceptional Muse](#exceptional-muse)         |    2    | Muse gets 1 Insight or 1 Flex.                                                                                  |
| [Gold Star](#gold-star)                       |   1/2   | +10 per level to rep and social skill tests with 1 faction.                                                     |
| [Habitat Tranquility](#habitat-tranquility)   |    1    | +10 INT Checks to heal stress and reduce healing time for stress/traumas/disorders by half in one specific hab. |
| [Hard Knocks](#hard-knocks)                   |    6    | Regain 1 pool when you roll a critical failure (max 3 between long recharges).                                  |
| [Home Turf](#home-turf)                       |    1    | Gain 1 ego Flex to use on tests involving specified habitat.                                                    |
| [Improved Beta](#improved-beta)               |    1    | Choose one benefit for beta forks (see trait description).                                                      |
| [Inspiring Moves](#inspiring-moves)           |    6    | When you roll a critical success, ally regains 1 pool point (max 3 between long recharges).                     |
| [Intrusion Speed](#intrusion-speed)           |    2    | Reduce timeframe for subtle intrusions by half.                                                                 |
| [Manipulative Streak](#manipulative-streak)   |    2    | Use Moxie to flip-flop defender’s roll against your Deceive/Persuade/Provoke Tests.                             |
| [Melee Mastery](#melee-mastery)               |    2    | Use Vigor to flip-flop opponent’s roll in melee.                                                                |   Melee skill 60+ |
| [Meme Fame](#meme-fame)                       |    2    | +10 to social skills/Rep Tests on first interaction with NPC who recognizes you from meme.                      |
| [Mental Fortitude](#mental-fortitude)         |    2    | You never suffer acute stress responses.                                                                        |
| [Merging Mastery](#merging-mastery)           |    1    | No memory loss when merging forks, except crit fail equals minor memory loss.                                   |
| [Mind Flayer](#mind-flayer)                   |    2    | Ignore −30 modifier when mindware hacking.                                                                      | Infosec skill 60+ |
| [Minion/Partner](#minionpartner)              |    6    | An NPC backs you up.                                                                                            |
| [Morph Attunement](#morph-attunement)         |    1    | +10 to either Athletics, Fray, Free Fall, Infiltrate, or Pilot with one specific morph.                         |
| [Morph Mastery](#morph-mastery)               |    4    | No Integration Tests sleeving one category of morphs (biomorphs, synthmorphs/axles, infomorphs/core morphs).    |
...
| [Spacecraft](#spacecraft)                     |    6    | You possess a spacecraft under your control.                                                                    |
| [Stress Immunity](#stress-immunity)           |    1    | Immune to stress/Stress Tests from one specific source.                                                         |
| [Synth Kinesics](#synth-kinesics)             |    1    | Ignore −30 Kinesics modifier when interacting with synths, infomorphs, etc.                                     |
| [Temptation Immunity](#temptation-immunity)   |    2    | You never make mental Addiction Tests.                                                                          |
| [Untarnished Rep](#untarnished-rep)           |    1    | —30 to attempts to target your rep in one network; rep losses in that network halved.                           |
| [Uplift Affinity](#uplift-affinity)           |    1    | +10 social skills when interacting with uplifts.                                                                |
...
| [Botched Merge](#botched-merge)                       |    2     | INT Check or long-term memories seem false; remember wrong info on superior/critical failure.                               |
| [Brittle Psyche](#brittle-psyche)                     |    2     | First result on influence table is 1d6 SV. Take 1d6 SV when pushing sleights.                                               |             Asyncs |
| [Curbed Intelligence](#curbed-intelligence)           |    1     | Max COG of 10, timeframe for improving/learning skills is doubled.                                                          |       AGIs/Uplifts |
| [Data Footprint](#data-footprint)                     |  1/2/3   | +10 per level to Research/Rep Tests to track or find info on you online.                                                    |
| [Debt](#debt)                                         |    4     | You owe person/group, must pay Moderate favor or GM-determined cost each week.                                              |
| [Deferred Indenture](#deferred-indenture)             |    1     | You owe indentured labor, equal to Major favor or several weeks of work.                                                    |
| [Dependent](#dependent)                               |    1     | Responsible for NPC ward.                                                                                                   |
| [Divergent Personality](#divergent-personality)       |    1     | Treat fork’s time apart as one step lower on Merging Table.                                                                 |
| [Domineering Impulses](#domineering-impulses)         |    2     | WIL Check to use Deceive/Persuade over intimidation or to not respond to threats in kind.                                   |            Uplifts |
| [Emotion Susceptibility](#emotion-susceptibility)     |    4     | −20 to resist emotional manipulation. WIL Check against intense emotions or stunned.                                        |               AGIs |
| [Emotive Blindness](#emotive-blindness)               |    2     | Max Kinesics of 40 and may not spend pool on Kinesics Tests.                                                                |
| [Errant Fork](#errant-fork)                           |    2     | Alpha fork is an enemy, a complication, or is missing.                                                                      |
| [Identifiable Quirk](#identifiable-quirk)             |    1     | −30 Deceive Tests to impersonate and against attempts to identify you with Kinesics.                                        |
| [Impaired Linguistics](#impaired-linguistics)         |    2     | CP/RP for languages doubled. Must make COG Checks with Stress Tests or lose language abilities for 1d6 minutes.             |            Uplifts |
| [Implicit Bias](#implicit-bias)                       |    2     | Once per session, GM may provide false information on a Know or Research Test.                                              |
| [Mesh Naiveté](#mesh-naiveté)                         |    4     | Max Infosec, Interface, Program, Research of 40; may not use pool with these skills.                                        |
| [Messy Mind](#messy-mind)                             |    2     | Psychosurgery procedures inflict an extra +1d6/+2 SV.                                                                       |
| [Micrograv Disorientation](#micrograv-disorientation) |    2     | −30 INT Checks and Survival Tests to navigate space/beehives/clusters. Reduce Insight pool by 1 in these conditions.        |
| [Morph Aversion](#morph-aversion)                     |  1/2/3   | −10 per level to Integration and Resleeving Stress Tests with one category of morphs.                                       |
| [Need for Solitude](#need-for-solitude)               |    4     | When interacting with others for 2+ hours, modifiers and WIl checks apply; see text.                                        |
| [On the Run](#on-the-run)                             |    2     | Sought by authorities.                                                                                                      |
| [Poor Socialization](#poor-socialization)             |    2     | −10 Deceive/Persuade/Provoke when interacting with NPC for first time.                                                      |
| [Slow Reaction Time](#slow-reaction-time)             |    2     | /4 −1 Initiative per level.                                                                                                 |
| [Social Ineptitude](#social-ineptitude)               |    4     | Once per session, one social interaction treated as a critical failure.                                                     |
| [Stolen Identity](#stolen-identity)                   |    2     | Ongoing complications from a previous stolen identity incident.                                                             |
| [Stress Vulnerability](#stress-vulnerability)         |    1     | Double the SV from one specific source of stress.                                                                           |
| [Submissiveness](#submissiveness)                     |  1/2/3   | −10 per level to resist Persuade/Provoke from NPCs with superior capabilities or higher social status.                      |
| [Subverted Mind](#subverted-mind)                     |    6     | Your mind is programmed without your knowledge; see text.                                                                   |
| [Thorough Infection](#thorough-infection)             |    4     | Reduce Infection Rating by 5 for short recharges and 20 for long recharges.                                                 | Asyncs (Psi Lvl 2) |
| [Uncooperative Tendencies](#uncooperative-tendencies) |    2     | You do not benefit from teamwork bonuses. Apply a −10 when you attempt teamwork with others.                                |
| [Unreliability](#unreliability)                       |    4     | Once per session, GM can designate that you are not allowed to use pools on a specific test.                                |
