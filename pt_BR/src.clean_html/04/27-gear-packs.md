...
| [Vestuário Inteligente](../16/05-common-tech-and-ware.md#everyday-technology)\* |                 Men/1                 | Pode alterar as cores, texturas e modelo. +10 em Infiltração, +30 se coberto e estacionário. |
...
| EQUIPAMENTOS                                         | Comp/<!-- CLEANED wbr -->PE | Descrição                      |
|:---------------------------------------------------- |:-------------------------------------:|:------------------------------ |
| [Antirreflexo](../16/06-sensory-augmentations.md)    |                 Men/1                 | Sem modificadores por clarões. |
...
| [Segurança Aprimorada](../16/12-meshware.md)           |                 Mod/2                 | −10 em Infoseg para hackear, −30 em modo defensivo mas sem parada de Inspiração e com −3 em INIT. |
| [App de Violação](../16/13-apps-and-alis.md#apps)      |                Mod/R/2                | Ferramenta de bibliotecas de hackeamento.                                                         |
...
| [Projetor Holográfico](../16/05-common-tech-and-ware.md#everyday-technology) |                 Men/1                 | Projeta imagens/vídeos 3D, HD, ultrarrealistas. +20 em Percepção para notar que é falso a 20&nbsp;m. |
...
| [Neem (5 doses)](../16/15-chemicals-drugs-and-toxins.md#cognitive-drugs)     |                 Men/1                 | +20 em Provas de COG para se lembrar de coisas aprendidas sob efeito de Neem.                        |
| [SolArchive Portátil](../16/18-mission-gear.md#science-tools)                |                 Men/1                 | Permite Testes de Pesquisa relacionados a uma perícia de Saber estando isolado da mesh.              |
...
| EQUIPAMENTOS                                                                      | Comp/<!-- CLEANED wbr -->PE | Descrição                                                                                               |
|:--------------------------------------------------------------------------------- |:-------------------------------------:|:------------------------------------------------------------------------------------------------------- |
| [Manto Camaleão](../16/17-espionage-and-security-tech.md)                         |                 Mod/2                 | Camuflagem, +10 em Infiltração, +30 se estacionário.                                                    |
| [Exame Faxineiro](../16/20-nanoswarms-and-microswarms.md#swarms)                  |                 Men/1                 | Limpa e elimina evidências forenses.                                                                    |
| [Ferramenta de Operações de Infiltração](../16/17-espionage-and-security-tech.md) |                Mai/R/3                | Burla fechaduras, abrir/fechar buracos, Aparelhagem: Eletrônica 60 vs. fechaduras eletrônicas e outros. |
...
| EQUIPAMENTOS                                                           | Comp/<!-- CLEANED wbr -->PE | Descrição                                                                           |
|:---------------------------------------------------------------------- |:-------------------------------------:|:----------------------------------------------------------------------------------- |
| [Aggro (5 doses)](../16/15-chemicals-drugs-and-toxins.md#combat-drugs) |                 Men/1                 | +20 em Provocação para intimidar/zombar, −20 em outros testes sociais.              |
...
| [Ampliação Muscular](../16/10-combat-augmentations.md)                 |                 Mai/3                 | Músculos aprimorados como miofibras. +1d6&nbsp;VD luta, +10 em Provas de SOM.       |
...
| EQUIPAMENTOS                                                           | Comp/<!-- CLEANED wbr -->PE | Descrição                                                                                                  |
|:---------------------------------------------------------------------- |:-------------------------------------:|:---------------------------------------------------------------------------------------------------------- |
| [Audição Aprimorada](../16/06-sensory-augmentations.md)                |                 Men/1                 | Ouvir frequências mais altas e mais baixas. +10 em Percepção baseado em audição.                           |
| [Anjo da Guarda](../16/21-robots.md#combat-bots)                       |                 Mod/2                 | Drone de defesa pessoal. Tamanho pequeno.                                                                  |
...
| [Stiff (5 doses)](../16/15-chemicals-drugs-and-toxins.md#social-drugs) |                 Men/1                 | +10 em Provas de SAG/VON vs. Persuasão/Provocação, Comportamento Acentuado: Teimosia (Nível 2).            |
...
| [Twitch (5 doses)](../16/15-chemicals-drugs-and-toxins.md#toxins)         |                Men/R/1                | –20 em ações, Prova de SOM vs. incapacitação.                                     |
...
| [App Farejador](../16/13-apps-and-alis.md#apps)                         |                 Mod/2                 | Coleta/monitora o tráfego entre dois sistemas.       |
| [App Mascarador](../16/13-apps-and-alis.md#apps)                        |                Mod/R/2                | Falsifica transmissões e mesh IDs.                   |
| [App Rastreador](../16/13-apps-and-alis.md#apps)                        |                 Mod/2                 | Rastreia conexões.                                   |

### Investigador

| EQUIPAMENTOS                                                                | Comp/<!-- CLEANED wbr -->PE | Descrição                                                                                 |
|:--------------------------------------------------------------------------- |:-------------------------------------:|:----------------------------------------------------------------------------------------- |
| [Comparador Biométrico](../16/13-apps-and-alis.md#apps)                     |                 Men/1                 | Compara padrões biométricos.                                                              |
