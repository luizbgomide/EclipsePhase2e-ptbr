...
- **Meshware (M)** refere-se a apps complementares que aprimoram infomorfos. Eles também podem ser instalados em cibercérebros. Eles são vulneráveis ao combate na mesh. User Programação para instalar, diagnosticar ou reparar.
