...
- **Operar Dispositivo:** A maioria dos dispositivos possui hardware embutido e funções eletrônicas que você pode controlar diretamente. Ligar o seu veículo, carregar uma matriz de autocook, aumentar o aquecimento, desligar os sprinklers, abrir a porta, definir um temporizador, disparar um sistema de armas, ajustar configurações, etc. Ao critério do MJ, algumas funções pode exigir testes de perícia.
