...
- **Ativar Contramedidas:** Iniciar contramedidas ativas contra um intruso detectado ([Contramedidas Ativas](../13/12-countermeasures.md#active-countermeasures)).
...
- **Localizar Intruso:** Tentar encontrar um intruso suspeito ([Localizar Intruso](../13/12-countermeasures.md#locate-intruder)).
- **Barrar:** Bloquear um mesh ID específico de acessar o sistema.
...
- **Limpar Sistema:** Apagar todos os dados do sistema, leva 1 minuto para ciscos, 3 minutos para hosts e 10 para servidores.
...
- **Instalar Porta dos Fundos:** Criar um caminho secreto de volta para o sistema.
...
- **Interromper Fluxo da Pilha Cortical:** Cortar o backup em andamento.
...
- Quase todos os testes de hackeamento colocam a Infoseg do hacker vs. a Firewall do sistema alvo.
...
| Sucesso Crítico               | Hacker alcança todos os objetivos, instala porta dos fundos no sistema.    |
