...
A mesh mudou a forma como as pessoas vivem. Conspirações profundas deixam migalhas digitais que podem descobertas, se o investigador souber onde procurar. Hackers podem manipular fluxos de RA e transmissões de notícias, alterando a percepção do alvo da realidade. Habitats inteiros migraram para um existência puramente digital, com dezenas de milhares de cidadões infomorfos conduzindo suas vidas em tempo acelerado. A maioria considera a mesh outro aprimoramento da vida; uma forma mais rápida de entregar conteúdo e interagir com produtos. Para outros, a vida virtual é a maior fronteira da transumanidade.
