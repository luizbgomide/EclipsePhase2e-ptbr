...
| Interface                                                                | 30 |
| Pesquisa                                                                 | 60 |
| <!--sort-fixed-->Saber: (Escolha Uma)                          | 60 |
| <!--sort-fixed-->Saber: (Escolha Uma)                          | 40 |
| <!--sort-fixed-->Saber: (Escolha Uma) <p class="indent">_Áreas Comuns: Administração, Instrução, Operações Laboratoriais_</p> | 30 |
...
| Infiltração                                                              | 60 |
| Infoseg                                                                  | 30 |
| <!--sort-fixed-->Saber: (Escolha Uma) <p class="indent">_Áreas Comuns: Contrabando, Espionagem, Operações de Segurança_</p> | 60 |
| <!--sort-fixed-->Saber: (Escolha Uma)<p class="indent">_Áreas Comuns: Atualidades, Mercados Negros, Política_</p> | 30 |
...
| Infoseg                                                                   | 40 |
| Programação                                                               | 30 |
| <!--sort-fixed-->Saber: (Escolha Uma)<p class="indent">_Áreas Comuns: Construção, Mineração, Nanofabricação, Operações de Habitat_</p> | 60 |
| <!--sort-fixed-->Saber: (Escolha Uma)<p class="indent">_Áreas Comuns: Ciência da Computação, Engenharia, Nanotecnologia_</p> | 30 |
