...
| Luva de Fantoche  |      CH      |                 Mod/2                 | Permite que o morfo seja controlado remotamente.                               |
...
- **Sensores Médicos/Diagnósticos:** Esta conjunto monitora a sua saúde, incluindo frequência cardíaca, respiração, pressão arterial, temperatura, atividade neural, status dos wares e muito mais. Em sintemorfos, esse sistema monitora relatórios do sistema e logs de erros, falhas por desgaste, e status semelhantes de hardware.
...
**Sensor Portátil:** Este é um pequeno sistema (possivelmente vestível) de sensores portáteis. O tipo de sensor deve ser escolhido (por exemplo: infravermelho, lidar, radar, raio X). Sistemas de sensores combinados também estão disponíveis, com um custo cumulativo. Veja [Sentidos e Sensores](../16/07-senses-and-sensors.md) e [Alcances de Rádios e Sensores](../16/16-comms-and-mesh-gear.md#radio-and-sensor-ranges).
...
**Carregador Solar:** Esta pequena unidade portátil se desdobra em painéis solares altamente eficientes, sendo úteis para coletar luz solar e carregar eletrônicos ou recarregar baterias. Ele é comum em operações de desbravamento e mineração de asteroides, embora a produção de energia dependa da proximidade com o sol/estrela.

**Visor:** O visor é um óculos ou máscara de aprimoramento de visão. Ele fornece todos os benefícios de [visão aprimorada](../16/06-sensory-augmentations.md) e inclui um [emissor de raios T](../16/06-sensory-augmentations.md). Ele fornece um bônus +10 em Testes de Percepção.
