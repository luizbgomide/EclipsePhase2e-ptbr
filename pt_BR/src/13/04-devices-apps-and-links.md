...
Os infomorfos são pacotes ativados de emulação mental — inteligências programáticas digitais. Eles são detalhados em [Infomorfos](../13/08-infomorphs.md).
