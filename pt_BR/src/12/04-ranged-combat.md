...
| Disparo em Rajada         |                                                         |
| <p class="indent">» Alvo Único</p> | +10 para acertar ou +1d10&nbsp;VD                       |
| <p class="indent">» Dois Alvos Adjacentes</p> | VD padrão para ambos                                    |
| Totalmente Automático     |                                                         |
| <p class="indent">» Alvo Único</p> | +20 para acertar ou +2d10&nbsp;VD                       |
| <p class="indent">» Três Alvos Adjacentes</p> | VD padrão para os três                                  |
| <p class="indent">» Fogo de Supressão</p> | VD padrão para qualquer um sem cobertura dentro do cone |
...
|:--------------------------------------------------------------- |:-----------------------------------------------------------------------------------------------:|
| Alcance                                                         |                                                                                                 |
| <!--sort-union--><p class="indent">» Queima-Roupa (2&nbsp;m)</p>            |                                               +10                                               |
| <!--sort-union--><p class="indent">» Perto (10&nbsp;m)</p>            |                                               +0                                                |
| <!--sort-union--><p class="indent">» Alcance</p>           |                                               −10                                               |
| <!--sort-union--><p class="indent">» Além do Alcance</p>           |            −10 por incremento de Alcance<br>−1d10&nbsp;VD para armas cinéticas            |
...
| <!--sort-union--><p class="indent">» Disparo em Rajada (Concentrado)</p>            |                                      +10 ou +1d10&nbsp;VD                                       |
| <!--sort-union--><p class="indent">» Totalmente Automático (Concentrado)</p>            |                                      +30 ou +2d10&nbsp;VD                                       |
| Pontaria (Ação Rápida)                                          |                                               +10                                               |
| <!--sort-union-->Pontaria (Ação Complexa)             |                                               +30                                               |
| Tiro Indireto                                                   |                                               −20                                               |
