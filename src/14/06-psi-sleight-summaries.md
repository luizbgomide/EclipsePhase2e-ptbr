...
**Range:** Self, Point-Blank, or Close ([Psi Range](04-using-psi.md#psi-range)).

**Action:** Automatic, Quick, Complex, or Task ([Actions & Time](../03/03-actions-and-time.md)).

**Duration:** Constant, Instant, Sustained, or your WIL ÷ 5 in either action turns, minutes, or hours ([Duration](04-using-psi.md#duration)).

**Infection Mod:** Added to your Infection Rating ([Infection Modifiers](04-using-psi.md#infection-modifiers)).
...
**Action:** Complex • **Duration:** Minutes • **Infection Mod:** 8
