...
|  04   | You find a morph that fits you like a glove. Gain theMorph Attunement trait ▶136. Roll on the Random Morph tables ▶50.                                                                                                             |
...
|  07   | You fall victim to a terrorist attack or factional dispute. Roll on the Random Morph tables ▶50.                                                                                                                                   |
|  08   | You reinvent yourself. Increase one aptitude by 5 and reduce another by 5. Roll 1d6: 1 COG, 2 INT, 3 REF, 4 SAV, 5 SOM, 6 WIL.                                                                                                     |
|  09   | You get caught in a post-Fall breakout and are infected with Watts-MacLeod (▶272, EP2). Gain the Psi (Level 1) trait and 2 psichi sleights (pick or roll randomly on the Sleights table ▶52).                                      |
|  10   | You find it hard to cope with the Fall and its aftermath. Gain the Addiction (Level 2) trait (▶76, EP2).                                                                                                                           |
| 11–12 | You get caught in a post-Fall breakout and are infected with Watts-MacLeod (▶272, EP2). +10 Psi skill and gain the Psi (Level 2) trait and 1 psi-gamma sleight (pick or roll randomly on the Sleights table ▶52).                  |
| 13–14 | You use the post-Fall chaos to establish a new identity. Gain a fake ego ID (▶315, EP2) for free.                                                                                                                                  |
...
| 18–19 | You run afoul of a criminal cartel agent. You walk away unscathed, but the matter is far from resolved. Gain the Enemy trait (▶77, EP2).                                                                                           |
| 20–21 | You commit a crime, get caught, and suffer the punishment. Gain the Restricted Behavior (Level 2) trait (▶80, EP2).                                                                                                                |
|  22   | You have died enough times that your mind really can’t take it any more. Roll on the Random Morph tables ▶50 and gain the Mental Disorder (Phobia: Death) trait (▶79 and 225, EP2).                                                |
|  23   | You interact with people from an opposing faction often, and you get good at pressing their buttons. +10 Provoke skill.                                                                                                            |
|  24   | An ownerless bot follows you and never leaves your side. Gain a servitor, saucer, or gnat bot (▶348–349, EP2) for free.                                                                                                            |
|  25   | An unknown party leaves you a portable QE comm unit with a qubit reservoir (▶337, EP2), telling you only to expect a call in the future.                                                                                           |
|  26   | You travel extensively. Gain a new language and roll on the Random Morph tables ▶50.                                                                                                                                               |
|  27   | You’ve gotten really good at resleeving. Roll on the Random Morph tables ▶50 and gain the Adaptability (Level 2) trait (▶72, EP2).                                                                                                 |
|  28   | You create a major diplomatic incident. Gain the Black Mark (Level 2) trait (▶77, EP2). Roll on the Faction table ▶34 to determine which.                                                                                          |
...
|  31   | You come into possession of 5 doses of the psi-opener drug (▶334, EP2). Roll on the Sleights table ▶52 to determine effects.                                                                                                       |
|  32   | You fall on hard times. Lose one level of Resources trait. If you don’t have Resources, roll on the Random Morph tables ▶50 but only take a synthmorph or infomorph of MP 2 or less.                                               |
|  33   | You establish a relationship with someone in-the-know. Gain the Contact trait (▶73, EP2). Choose a rep network or roll randomly on the Rep Networks table ▶55.                                                                     |
|  34   | You are victimized by an async. Gain the Psi Defense (Level 2) trait (▶74, EP2).                                                                                                                                                   |
...
|  41   | You try a lot of morphs, but only one hits the spot. Gain the Morph Familiarity trait (▶74, EP2). Choose a morph or roll randomly on the Random Morph tables ▶50.                                                                  |
|  42   | An unpopular choice burns many bridges. Gain the Blocklisted Rep trait (▶77, EP2). Choose a rep network or roll randomly on the Rep Networks table ▶55.                                                                            |
|  43   | A friend or relative opts for true death, but bequeaths you their estate. Gain Resources (Level 2) trait.                                                                                                                          |
|  44   | You experiment with a number of morphs. Increase SOM by 5 and roll on the Random Morph tables ▶50.                                                                                                                                 |
...
|  47   | You have difficulty coming to grips with regular resleeving. Gain the Identity Crisis trait (▶78, EP2) and roll on the Random Morph tables ▶50.                                                                                    |
|  48   | A resleeve goes particularly poorly, and now it haunts you. Roll on the Random Morph tables ▶50 and gain the Morphing Disorder (Level 2) trait (▶79, EP2).                                                                         |
...
|  53   | You decide to take a risk and let the universe decide your fate. Gain the No Backup Insurance trait (▶79, EP2).                                                                                                                    |
...
|  68   | You have an exceptionally horrible resleeving experience and swear off that type of morph. Roll on the Random Morph tables ▶50 and gain the Morph Aversion (Level 2) trait ▶140.                                                   |
|  69   | The state of post-Fall transhumanity inspires you to up your game. Increase COG by 5.                                                                                                                                              |
|  70   | Through a strange set of circumstances, you end up with a stash of 5 inquisitive green petal flowers (▶333, EP2).                                                                                                                  |
|  71   | You get stuck with a boring, repetitive job, but at least you get really good at it. Gain one specialization (▶48, EP2) in a skill of your choice.                                                                                 |
|  72   | Doing your part to aid transhumanity’s regrowth, you have a kid. Gain the Dependent trait ▶138.                                                                                                                                    |
|  73   | You are killed in a severe accident. Decrease REF by 5 and roll on the Random Morph tables ▶50.                                                                                                                                    |
...
|  76   | A troll hacker damages your rep but leaves you with a gift. −10 to a rep score of your choice but gain a kaos AI (▶326, EP2).                                                                                                      |
|  77   | You take in an abandoned animal. Gain a smart dog, smart monkey, or smart rat (▶328, EP2).                                                                                                                                         |
|  78   | You discover that you work well with machines. Gain the Drone Affinity trait (▶73, EP2).                                                                                                                                           |
...
|  84   | Your exceptional nature is noticed. Gain the Patron trait (▶74, EP2).                                                                                                                                                              |
...
| 86–87 | You experience a catastrophic sleeving accident. Start play with 10 points of stress and roll on the Random Morph tables ▶50.                                                                                                      |
...
| 90–91 | You fall in with a new crowd — one that will have your back. Gain the Allies trait (▶72, EP2).                                                                                                                                     |
...
|  96   | While no specific morph outshines the others, you definitely lean towards a type. Roll on the Random Morph tables ▶50 and gain the Morph Mastery trait ▶136.                                                                       |
