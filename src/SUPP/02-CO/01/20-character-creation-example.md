...
His first d100 roll on **4.0 Random Background Path** is 1 for **Colonist**, and so he jumps to [4.1 Colonist](./05-4-background-path.md#41-colonist-d100) and rolls d100 with a result of 81 — a **Spacer**. This character grew up on or worked on spaceships at a young age. Spacers roll a d10 for Morph and Adam hits a 5 for a **Splicer**.
